<template>
  <el-form ref="form" :model="form" label-width="120px">
    <el-form-item label="车辆品牌">
      <el-select v-model="form.name" placeholder="车辆品牌">
        <el-option label="福特" value="福特"></el-option>
      </el-select>
    </el-form-item>
    <el-form-item label="车辆型号">
      <el-select v-model="form.name" placeholder="车辆型号">
        <el-option label="福特" value="福特">HHHH</el-option>
      </el-select>
    </el-form-item>
    <el-form-item label="停车场">
      <el-select v-model="form.name" placeholder="停车场">
        <el-option label="福特" value="福特">南山停车场</el-option>
      </el-select>
    </el-form-item>
